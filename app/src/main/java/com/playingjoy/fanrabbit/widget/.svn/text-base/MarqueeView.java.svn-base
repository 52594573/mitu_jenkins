...
public class MarqueeView extends View implements Runnable {
    ...
    private int[] colors = new int[]{0xFFf2776e, 0xfffbbc61, 0XFFfadb47, 0xfffac159, 0xffea9b78};
    private LinearGradient mLinearGradient; //文字显示的线性渐变
...
//    }
     ...
     * @param colors
     */
    public void setTextShader(int[] colors) {
        this.colors = colors;
    }
