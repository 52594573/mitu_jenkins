...
public class EaseVoiceRecorderView extends RelativeLayout {
            ...
            case MotionEvent.ACTION_DOWN:
                try {
                    ...
                    if (voicePlayer.isPlaying())
                        voicePlayer.stop();
                    if (onStartRecordingListener.onStartRecord()){
                        v.setPressed(true);
                        startRecording();
                    }
                } catch (Exception e) {
    ...
    public void showReleaseToCancelHint() {
        ...
        micImage.setImageResource(R.drawable.ic_touch_up_cancle);
    ...
    public void showMoveUpToCancelHint() {
        isRecorde = true;
        recordingHint.setText(context.getString(R.string.move_up_to_cancel));
        micImage.setImageResource(R.drawable.ease_record_animate_01);
        recordingHint.setBackgroundColor(Color.TRANSPARENT);
    }
