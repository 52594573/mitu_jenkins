 ...
 */
public class EaseChatFragment extends EaseBaseFragment implements EMMessageListener, EaseVoiceRecorderView.OnStartRecordingListener {
    ...
    protected int[] itemStrings = {R.string.attach_picture, R.string.attach_take_pic, R.string.attach_file};
    ...
    protected int[] itemIds = {ITEM_PICTURE, ITEM_TAKE_PICTURE, ITEM_FILE};
    private boolean isMessageListInited;
    protected MyItemClickListener extendMenuItemClickListener;
    protected boolean isRoaming = false;
    private ExecutorService fetchQueue;
    private ArrayList<String> filePaths = new ArrayList<>();
    int REQUEST_CODE_PICKER_FILE = 1000;
    int MY_PERMISSIONS_REQUEST_CAMERA = 10;
    int MY_PERMISSIONS_REQUEST_RECORDER = 11;
    int MY_PERMISSIONS_REQUEST_STORAGE = 12;
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        filePaths.add(Environment.getDataDirectory().getPath());
        filePaths.add(Environment.getExternalStorageDirectory().getPath());
    ...
    protected void initView() {
        ...
        voiceRecorderView.setOnStartRecordingListener(this);
        // message list layout
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (resultCode == Activity.RESULT_OK) {
            if (requestCode == REQUEST_CODE_CAMERA) { // capture new image
                ...
                sendMessage(dingMsg);
            } else if (requestCode == REQUEST_CODE_PICKER_FILE) {
                ArrayList<String> filePaths = data.getStringArrayListExtra("paths");
                EMLog.i(TAG, "发送文件:" + filePaths.size());
    ...
    public void onRequestPermissionsResult(int requestCode, String[] permissions, int[] grantResults) {
        ...
        if (requestCode == MY_PERMISSIONS_REQUEST_CAMERA) {
            if (grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                ...
                Toast.makeText(getActivity(), "请赋予了app拍照权限", Toast.LENGTH_SHORT).show();
            }
        } else if (requestCode == MY_PERMISSIONS_REQUEST_RECORDER) {
            if (grantResults[0] != PackageManager.PERMISSION_GRANTED) {
                Toast.makeText(getActivity(), "请赋予了app录音权限", Toast.LENGTH_SHORT).show();
            }
        } else if (requestCode == MY_PERMISSIONS_REQUEST_STORAGE) {
            if (grantResults[0] != PackageManager.PERMISSION_GRANTED) {
                Toast.makeText(getActivity(), "请赋予app文件权限", Toast.LENGTH_SHORT).show();
            }
        }
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            if (ContextCompat.checkSelfPermission(getActivity(), Manifest.permission.RECORD_AUDIO)
                ...
                ActivityCompat.requestPermissions(getActivity(),
                        ...
                        MY_PERMISSIONS_REQUEST_RECORDER);
            ...
            switch (itemId) {
                ...
                case ITEM_FILE:
                    ...
                    if (ContextCompat.checkSelfPermission(getActivity(), Manifest.permission.WRITE_EXTERNAL_STORAGE) !=
                        ...
                        new LFilePicker()
                                .withSupportFragment(EaseChatFragment.this)
                                .withRequestCode(REQUEST_CODE_PICKER_FILE)
                                .withMutilyMode(true)
                                .withMaxNum(9)
                                .start();
                    }
